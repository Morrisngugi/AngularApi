...
{
    public class PersonInformationsController : ApiController
    {
        private TestEntities db = new TestEntities();

        // GET: api/PersonInformations
        public IQueryable<PersonInformation> GetPersonInformations()
        {
            return db.PersonInformations;
        }

        // GET: api/PersonInformations/5
        ...
        // DELETE: api/PersonInformations/5
        [ResponseType(typeof(PersonInformation))]
